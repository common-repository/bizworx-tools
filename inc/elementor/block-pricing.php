 ...
 *
 * Elementor widget that displays the pricing table in theme.
 *
 * @since 1.0.0
 */
class Bizworx_Pricing_Table extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pricing table', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Pricing Content', 'elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => __( 'This is a feature', 'elementor' ),
					],
					[
						'text' => __( 'This is a feature', 'elementor' ),
					],
				...
				'fields' => [
					[
						'name' => 'text',
						'label' => __( 'Feature info', 'elementor' ),
						'type' => Controls_Manager::TEXT,
						'label_block' => true,
						'placeholder' => __( 'This is a feature', 'elementor' ),
						'default' => __( 'This is a feature', 'elementor' ),
					],
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 		=> Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pricing-section .plan-period span' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .pricing-section .plan-period span' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
		...
		$this->add_control(
			...
			[
				...
				'type' 		=> Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .pricing-section .plan-header' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .pricing-section .plan-header' => 'padding: {{SIZE}}{{UNIT}} 0;',
				],
				'default' => [
					'unit' => 'em',
				],
		...
		<div class="pricing-section">
			...
			<div class="plan-header">
				...
				<div class="plan-price">
					<span><?php echo $settings['currency']; ?></span><?php echo $settings['price']; ?>
				</div>
				<div class="plan-period">
					<span>per <?php echo $settings['period']; ?></span>		
				</div>				
			</div>
...
Plugin::instance()->widgets_manager->register_widget_type( new Bizworx_Pricing_Table() );