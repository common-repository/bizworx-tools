 ...
 *
 * Elementor widget that displays posts slider.
 *
 * @since 1.0.0
 */
class Bizworx_Posts extends Widget_Base {
	...
	public function get_title() {
		return __( 'Posts slider', 'elementor' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'number',
			[
				'label' => __( 'Count of Posts', 'elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'See all posts', 'elementor' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .bizworx-latest-news.carousel h4 a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' 	=> '{{WRAPPER}} .bizworx-latest-news.carousel h4',
		...
		$this->add_control(
			...
			[
				...
				'type' 		=> Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bizworx-latest-news.carousel.style2 .meta-post' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 		=> Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bizworx-latest-news.carousel.style2 .meta-post a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .bizworx-latest-news.carousel.style2 .blog-post:hover .meta-post a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' 	=> '{{WRAPPER}} .bizworx-latest-news.carousel .meta-post',
				'scheme' 	=> Scheme_Typography::TYPOGRAPHY_3,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 		=> Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .bizworx-latest-news.carousel .blog-post .entry-summary' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' 	=> '{{WRAPPER}} .bizworx-latest-news.carousel .blog-post .entry-summary',
				'scheme' 	=> Scheme_Typography::TYPOGRAPHY_3,
			]
		);
	...
	protected function render() {
		...
		(( \Bizworx_Tools::is_pro() ) ? $style = $settings['style'] : $style = 'style1');
		...
		<div class="bizworx-grid-posts">
			<div class="bizworx-latest-news carousel owl-carousel row <?php echo esc_attr( $style ); ?>">
	...
	/**
	 * Render post widget output in the editor.
	 *
...
Plugin::instance()->widgets_manager->register_widget_type( new Bizworx_Posts() );